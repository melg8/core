...
char const EmotesEntryfmt[]="nsxiiix";
...
char const SkillRaceClassInfofmt[]="diiiiiix";
char const SkillTiersfmt[] = "niiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii";
char const SpellCategoryfmt[] = "ni";
char const SpellCastTimefmt[]="niii";
