...
struct Cell
{
    ...
    template<class T, class CONTAINER, typename Map> void Visit(CellPair const& cellPair, TypeContainerVisitor<T, CONTAINER>& visitor, Map& m, float x, float y, float radius) const;
    template<class T, class CONTAINER, typename Map, typename WorldObject> void Visit(CellPair const& cellPair, TypeContainerVisitor<T, CONTAINER>& visitor, Map& m, WorldObject const& obj, float radius) const;

    static CellArea CalculateCellArea(float x, float y, float radius);

    template<class T, typename WorldObject> static void VisitGridObjects(WorldObject const* obj, T &visitor, float radius, bool dont_load = true);
    template<class T, typename WorldObject> static void VisitWorldObjects(WorldObject const* obj, T &visitor, float radius, bool dont_load = true);
    template<class T, typename WorldObject> static void VisitAllObjects(WorldObject const* obj, T &visitor, float radius, bool dont_load = true);

    template<class T, typename Map> static void VisitGridObjects(float x, float y, Map* map, T &visitor, float radius, bool dont_load = true);
    template<class T, typename Map> static void VisitWorldObjects(float x, float y, Map* map, T &visitor, float radius, bool dont_load = true);
    template<class T, typename Map> static void VisitAllObjects(float x, float y, Map* map, T &visitor, float radius, bool dont_load = true);

private:
    template<class T, class CONTAINER, typename Map> void VisitCircle(TypeContainerVisitor<T, CONTAINER>&, Map&, CellPair const&, CellPair const&) const;
};
...
template<class T, class CONTAINER, typename Map, typename WorldObject>
inline void
...
template<class T, class CONTAINER,  typename Map>
inline void
...
template<class T, typename WorldObject>
